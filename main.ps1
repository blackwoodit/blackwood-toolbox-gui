...
$Xaml = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" Width="800" Height="600" Name="Main" HorizontalAlignment="Left" VerticalAlignment="Top" Background="#000000" BorderThickness="1,1,0,1" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" OverridesDefaultStyle="True" Foreground="#000000" BorderBrush="#000000" Grid.Row="" Grid.Column=""><Window.Resources>
	<ResourceDictionary>
...
<Image HorizontalAlignment="Left" Height="75" VerticalAlignment="Top" Width="300" Name="ImageLogo" Source="https://blackwoodit.co.uk/wp-content/uploads/2020/03/blackwood-logo.png" Margin="0,0,0,0"/>
</Window>
"@
